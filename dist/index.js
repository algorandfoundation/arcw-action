...
// node_modules/arcw-lint-js/arcw_lint_js.js
var require_arcw_lint_js = __commonJS({
  "node_modules/arcw-lint-js/arcw_lint_js.js"(exports, module2) {
    var imports = {};
...
${val.stack}`;
    ...
    function __wbg_adapter_18(arg0, arg1, arg2) {
      wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h62caea0471545992(arg0, arg1, addHeapObject(arg2));
    }
    ...
    module2.exports.lint = function(sources) {
    ...
    module2.exports.format = function(snippet) {
      try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        wasm.format(retptr, addBorrowedObject(snippet));
    ...
    function __wbg_adapter_25(arg0, arg1, arg2, arg3) {
      wasm.wasm_bindgen__convert__closures__invoke2_mut__h9124937be4ddb297(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
    }
    ...
    module2.exports.__wbg_readFile_cd4b91825a624919 = function() {
      return handleError(function(arg0, arg1) {
        const ret = readFile(getObject(arg0), getObject(arg1));
        return addHeapObject(ret);
      }, arguments);
    };
    module2.exports.__wbg_call_65af9f665ab6ade5 = function() {
      return handleError(function(arg0, arg1, arg2) {
        const ret = getObject(arg0).call(getObject(arg1), getObject(arg2));
        return addHeapObject(ret);
      }, arguments);
    };
    module2.exports.__wbg_new_52205195aa880fc2 = function(arg0, arg1) {
      try {
    ...
    module2.exports.__wbg_resolve_0107b3a501450ba0 = function(arg0) {
      const ret = Promise.resolve(getObject(arg0));
      return addHeapObject(ret);
    };
    module2.exports.__wbg_then_18da6e5453572fc8 = function(arg0, arg1) {
      const ret = getObject(arg0).then(getObject(arg1));
      return addHeapObject(ret);
    };
    module2.exports.__wbg_then_e5489f796341454b = function(arg0, arg1, arg2) {
...
var require_mappingTable = __commonJS({
  "node_modules/whatwg-url/node_modules/tr46/lib/mappingTable.json"(exports, module2) {
...
var require_tr46 = __commonJS({
  "node_modules/whatwg-url/node_modules/tr46/index.js"(exports, module2) {
    "use strict";
...
var require_dist_node11 = __commonJS({
  "node_modules/@octokit/plugin-throttling/dist-node/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function _interopDefault(ex) {
      return ex && typeof ex === "object" && "default" in ex ? ex["default"] : ex;
      ...
      state.retryLimiter.on("failed", async function(error, info) {
        ...
        const {
          ...
          if (/\bsecondary rate\b/i.test(error.message)) {
            ...
            const wantRetry2 = await emitter.trigger("secondary-limit", retryAfter2, options, octokit);
            return {
    ...
    exports.throttling = throttling2;
  }
});

// src/main.ts
var arcw = __toESM(require_arcw_lint_js(), 1);
...
async function main() {
  ...
  try {
    ...
    const octokit = new ThrottledOctokit(
      (0, import_utils.getOctokitOptions)(githubToken, { throttle })
    );
    switch (context.eventName) {
      ...
      case "pull_request_target":
        break;
      default:
        import_core.default.warning(
          "arcw-action should only be configured to run on pull requests"
        );
        return;
    }
    ...
    for (let item of uncheckedText.split(",")) {
      unchecked.push(`arc-${item.trim()}.md`);
    }
    ...
    const warningOnly = import_core.default.getInput("warning-only") == "true";
    const result = await arcw.lint(files);
    let hasErrors = false;
    for (let snippet of result) {
      ...
      switch ((_d = snippet.title) == null ? void 0 : _d.annotation_type) {
        ...
        case "Note":
        case "Info":
          import_core.default.notice(formatted, properties);
          break;
        case "Warning":
          import_core.default.warning(formatted, properties);
          break;
        case "Error":
        default:
          if (warningOnly) {
            ...
            import_core.default.error(formatted, properties);
            hasErrors = true;
          }
          break;
      }
    ...
    if (hasErrors) {
      import_core.default.setFailed("validation found errors :(");
    }
  } catch (error) {
    console.log(error);
    let msg = "failed";
    ...
    import_core.default.setFailed(msg);
  }
}
main();
/*!
